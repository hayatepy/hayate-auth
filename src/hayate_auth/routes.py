...
ROUTES = {
    ...
    ("GET", "/oauth2/consents"): _lazy("authorization_server", "list_consents"),
    ("POST", "/oauth2/consents/revoke"): _lazy("authorization_server", "revoke_consent"),
    ("POST", "/oauth2/token"): _lazy("authorization_server", "token"),
    ("POST", "/oauth2/revoke"): _lazy("authorization_server", "revoke_token"),
    ("POST", "/oauth2/introspect"): _lazy("authorization_server", "introspect_token"),
    ("POST", "/oauth2/register"): _lazy("authorization_server", "register_client"),
    ("POST", "/passkey/generate-register-options"): _lazy("passkey", "register_options"),
    ("POST", "/passkey/verify-registration"): _lazy("passkey", "verify_registration"),
    ("POST", "/passkey/generate-authenticate-options"): _lazy("passkey", "authenticate_options"),
    ("POST", "/passkey/verify-authentication"): _lazy("passkey", "verify_authentication"),
    ("GET", "/passkey/list-user-passkeys"): _lazy("passkey", "list_user_passkeys"),
    ("POST", "/passkey/delete-passkey"): _lazy("passkey", "delete_passkey"),
}
